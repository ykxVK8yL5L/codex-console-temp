...
DEFAULT_LOG_CLEANUP_MAX_ROWS = 50000
...
class CleanupLogsRequest(BaseModel):
    ...
    max_rows: int = Field(default=DEFAULT_LOG_CLEANUP_MAX_ROWS, ge=1000, le=5000000)
...
def log_stats():
    ...
    retention_days = max(
        1,
        int(getattr(settings, "log_retention_days", DEFAULT_LOG_CLEANUP_RETENTION_DAYS) or DEFAULT_LOG_CLEANUP_RETENTION_DAYS),
    )
    ...
    return {
        ...
        "max_rows": DEFAULT_LOG_CLEANUP_MAX_ROWS,
    }
