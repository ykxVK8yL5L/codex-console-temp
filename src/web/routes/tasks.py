...
SUPPORTED_DOMAINS = ("accounts", "selfcheck")
...
def cancel_unified_task(domain: str, task_id: str):
    ...
    raise HTTPException(status_code=400, detail="不支持的任务域")
