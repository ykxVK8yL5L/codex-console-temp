...
def test_update_settings_accepts_app_access_password_alias():
    settings = update_settings(webui_access_password="local-only-password")
    assert settings.webui_access_password.get_secret_value() == "local-only-password"
